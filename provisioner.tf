...
resource "null_resource" "all_in_one_provisioner" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo export CONTROLLER_IP=192.168.33.3 >> /home/lab/labip.sh",
      "echo export PUBLIC_NETWORK_GW_IP=172.24.4.1 >> /home/lab/labip.sh",
      "yum install -y git",
      "rm -rf /home/lab/all-in-one-overcloud-packet",
      "git clone ${var.lab_repo_url} -b ${var.lab_repo_branch} /home/lab/all-in-one-overcloud-packet --depth=1",
...
resource "null_resource" "monasca_provisioner" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo export CONTROLLER_IP=192.168.33.30 >> /home/lab/labip.sh",
      "yum install -y git",
      "rm -rf /home/lab/all-in-one-overcloud-packet",
      "git clone ${var.lab_repo_url} -b ${var.lab_repo_branch} /home/lab/all-in-one-overcloud-packet --depth=1",
      "chown -R lab:lab /home/lab/all-in-one-overcloud-packet",
